...
studentExpulsionSchema.index({ student: 1, effectiveAt: -1 });
studentExpulsionSchema.index({ membershipId: 1, effectiveAt: 1, status: 1 });

module.exports = mongoose.model('StudentExpulsion', studentExpulsionSchema);
