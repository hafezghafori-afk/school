...
const schoolWebsiteProfileSchema = new mongoose.Schema({
  ...
  heroPanelTagline: { type: localizedTextSchema, default: () => ({}) },
  heroHighlights: { type: [localizedListItemSchema], default: [] },
  heroTrustPoints: { type: [localizedListItemSchema], default: [] },
  programsIntro: { type: localizedTextSchema, default: () => ({}) },
  featuresSectionKicker: { type: localizedTextSchema, default: () => ({}) },
  featuresSectionTitle: { type: localizedTextSchema, default: () => ({}) },
  programsSectionKicker: { type: localizedTextSchema, default: () => ({}) },
  programsSectionTitle: { type: localizedTextSchema, default: () => ({}) },
  newsSectionKicker: { type: localizedTextSchema, default: () => ({}) },
  newsSectionTitle: { type: localizedTextSchema, default: () => ({}) },
  ctaSectionKicker: { type: localizedTextSchema, default: () => ({}) },
  ...
  aboutWhyTitle: { type: localizedTextSchema, default: () => ({}) },
  aboutWhyBody: { type: localizedTextSchema, default: () => ({}) },
  aboutValuesTitle: { type: localizedTextSchema, default: () => ({}) },
  aboutTimelineTitle: { type: localizedTextSchema, default: () => ({}) },
  aboutStats: { type: [localizedListItemSchema], default: [] },
  aboutValues: { type: [localizedListItemSchema], default: [] },
  aboutTimeline: { type: [localizedListItemSchema], default: [] },
  ...
  programs: { type: [localizedListItemSchema], default: [] },
