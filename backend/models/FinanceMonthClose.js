...
const financeMonthCloseSchema = new mongoose.Schema({
  ...
  snapshot: {
    ...
    totals: {
      ...
      approvedExpenseAmount: { type: Number, default: 0 },
      pendingExpenseCount: { type: Number, default: 0 },
      pendingExpenseAmount: { type: Number, default: 0 },
      unassignedTreasuryExpenseCount: { type: Number, default: 0 },
      unassignedTreasuryExpenseAmount: { type: Number, default: 0 },
      netCashAmount: { type: Number, default: 0 },
      treasuryInflowAmount: { type: Number, default: 0 },
      treasuryOutflowAmount: { type: Number, default: 0 },
      treasuryNetAmount: { type: Number, default: 0 },
    ...
    cashflow: {
      ...
      approvedExpenseTotal: { type: Number, default: 0 },
      approvedExpenseCount: { type: Number, default: 0 },
      netCashAmount: { type: Number, default: 0 },
      treasuryInflowAmount: { type: Number, default: 0 },
      treasuryOutflowAmount: { type: Number, default: 0 },
