...
const ERROR_MESSAGE_MAP = {
  ...
  exam_session_admin_creation_required: 'ساخت شقه فقط از حساب مدیریت امکان دارد.',
  exam_sheet_template_not_found: 'فارمت شقهٔ امتحان پیدا نشد یا غیرفعال است.',
  exam_score_component_total_mismatch: 'مجموع اجزای نمره با نمرهٔ رسمی این امتحان برابر نیست.',
  exam_session_duplicate_scope: 'برای این استاد، صنف، مضمون و امتحان قبلاً شقه ساخته شده است.',
  exam_session_teacher_assignment_required: 'برای این شقه باید یک تخصیص فعال از بخش «معرفی صنف به استاد» انتخاب شود.',
  exam_teacher_assignment_not_found: 'تخصیص انتخاب‌شده پیدا نشد.',
  exam_teacher_assignment_inactive: 'تخصیص انتخاب‌شده دیگر فعال نیست.',
  exam_teacher_assignment_year_mismatch: 'تخصیص استاد مربوط به این سال تعلیمی نیست.',
  exam_teacher_assignment_class_mismatch: 'تخصیص استاد مربوط به این صنف نیست.',
  exam_teacher_assignment_subject_mismatch: 'تخصیص استاد مربوط به این مضمون نیست.',
  exam_session_edit_locked: 'این شقه در وضعیت فعلی قابل ویرایش مستقیم نیست؛ از نسخهٔ اصلاحی استفاده کنید.',
  exam_session_structural_edit_blocked: 'به‌دلیل ثبت نمره یا ایجاد نتیجه، تغییر صنف، مضمون، نوع امتحان یا ساختار نمره مجاز نیست.',
  exam_session_delete_blocked: 'این شقه نمره یا وابستگی رسمی دارد و قابل حذف کامل نیست؛ آن را آرشیف یا نسخهٔ اصلاحی بسازید.',
  exam_session_archive_reason_required: 'برای آرشیف شقه، نوشتن دلیل الزامی است.',
  exam_session_has_promotions: 'این شقه در ارتقای شاگردان استفاده شده و قابل حذف یا آرشیف نیست.',
  exam_roster_sync_locked: 'فهرست شاگردان شقهٔ نهایی‌شده قابل همگام‌سازی مستقیم نیست؛ نخست نسخهٔ اصلاحی بسازید.',
  exam_session_invalid_date: 'تاریخ امتحان معتبر نیست.',
  exam_period_year_mismatch: 'دورهٔ انتخاب‌شده مربوط به سال تعلیمی انتخاب‌شده نیست. دورهٔ همان سال را انتخاب کنید.',
  exam_class_year_mismatch: 'صنف انتخاب‌شده مربوط به سال تعلیمی انتخاب‌شده نیست.',
  result_table_session_not_approved: 'این شقه هنوز توسط مدیریت تأیید نشده و وارد جدول نتایج نمی‌شود.',
