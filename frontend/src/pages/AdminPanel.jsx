...
const ADMIN_LEVEL_GROUP_ACCESS = {
  ...
  school_manager: new Set(['ثبت‌نام و شاگردان', 'کاربران و دسترسی', 'سیستم و تنظیمات', 'گزارش مالی', 'کارکنان مکتب', 'ثبتِ کارکنان', 'ارتباطات']),
  ...
  academic_manager: new Set(['آموزش و برنامه', 'ثبت‌نام و شاگردان', 'کارکنان مکتب', 'ثبتِ کارکنان', 'ارتباطات']),
  head_teacher: new Set(['آموزش و برنامه', 'ثبت‌نام و شاگردان', 'کارکنان مکتب', 'ثبتِ کارکنان', 'ارتباطات']),
  ...
  finance_manager: new Set(['مالی', 'گزارش مالی', 'کارکنان مکتب', 'ارتباطات']),
  finance_lead: new Set(['مالی', 'گزارش مالی', 'کارکنان مکتب', 'ارتباطات'])
};
